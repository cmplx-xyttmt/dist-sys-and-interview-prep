...
| 2026-09-26 | Sliding Window Maximum (fixed window max, heap + lazy deletion) | untimed | heap + lazy deletion passed unaided, O(n log n), two structures kept in step by hand; then the O(n) monotonic deque after one leading question ("smaller and older elements are dead"), value-based front pop, correct but subtle | 2026-10-03 |
